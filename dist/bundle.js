!(function (t) {
  ...
  function (t, e, n) {
    ...
    function g(t, e, n) {
      var i = {};
      for (var o in e) v(e[o]) ? (i[o] = e[o](t, i, n)) : r('Extension must be a function');
      for (var s in i) v(i[s].mount) && i[s].mount();
      return i;
    }
    function y(t, e, n) {
            ...
            y(n, 'root', {
              ...
              set: function (t) {
                d(t) && (t = document.querySelector(t)),
                  x(t) ? (n._r = t) : r('Root element must be a existing Html node');
              },
            }),
            y(n, 'track', {
              get: function () {
            ...
            apply: function (t) {
              for (var n = 0, i = t.length; n < i; n++) {
                ...
                (r[H[o][0]] = 0 !== n ? this.value / 2 + 'px' : ''),
                  n !== t.length - 1 ? (r[H[o][1]] = this.value / 2 + 'px') : (r[H[o][1]] = '');
              }
            },
            remove: function (t) {
              ...
              switch (o) {
                ...
                case '<':
                  '<' === i
                    ? (t.index = 0)
                    : this.isStart()
                    ? (t.isType('slider') && !t.settings.rewind) || ((this._o = !0), (t.index = n))
                    : s
          ...
          var i = new O(),
            ...
            c = {
              ...
              unbindSwipeStart: function () {
                i.off(W[0], e.Html.wrapper, a), i.off(W[1], e.Html.wrapper, a);
              },
          ...
          return (
            y(r, 'time', {
              get: function () {
                ...
                return f(n || t.settings.autoplay);
              },
            }),
            n.on(['destroy', 'update'], function () {
              r.unbind();
    ...
    new ((function (t) {
      function e() {
        return (
          s(this, e), l(this, (e.__proto__ || Object.getPrototypeOf(e)).apply(this, arguments))
        );
      }
      return (
        (function (t, e) {
